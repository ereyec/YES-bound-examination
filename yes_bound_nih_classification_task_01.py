...
if DATASET.lower() == "mnist":
    ...
    NIH_CSV_PATH = "/content/sample/sample_labels.csv"
    NIH_IMG_ROOT = "/content/sample/images"   # folder containing .png files
...
#02/11/2026 - changing train_dl and test_dl
train_dl = DataLoader(train_ds, batch_size=params.BATCH_SIZE, drop_last=True)
test_dl  = DataLoader(test_ds,  batch_size=params.BATCH_SIZE, drop_last=True)
