# Stable kmnist results
# Todo: experiments with CIR > 0.25, fix plot function
...
train_ds = KMNIST_20x20_Z(train_imgs, train_labels, n=5000, resolution=20)
test_ds  = KMNIST_20x20_Z(test_imgs,  test_labels,  n=5000, resolution=20)
