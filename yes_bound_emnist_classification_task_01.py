# EMNIST Balanced with additive Gaussian noise
...
class EMNIST_Noisy_Z(Dataset):
    def __init__(self, imgs_np, labels_np, n=5000, resolution=48,
                 num_classes=47, noise_type=None, noise_level=0.2,
                 noise_p=0.02,
...
train_ds = EMNIST_Noisy_Z(train_imgs, train_labels, n=5000, resolution=48,
                          num_classes=47,
                          noise_type="gaussian", noise_level=0.15,
                          noise_on_train_only=True, is_train=True)

test_ds  = EMNIST_Noisy_Z(test_imgs,  test_labels,  n=5000, resolution=48,
                          num_classes=47,
                          noise_type="gaussian", noise_level=0.15,
